...
add_custom_command(
    ...
    COMMAND ${Python3_EXECUTABLE} ${MICROPY_PY_DIR}/makeqstrdefs_preprocessed.py --compiler ${CMAKE_C_COMPILER} --output ${MICROPY_QSTRDEFS_PREPROCESSED} --inputs ${MICROPY_QSTRDEFS_PY} ${MICROPY_QSTRDEFS_PORT} ${MICROPY_QSTRDEFS_COLLECTED} --cflags ${MICROPY_CPP_FLAGS}
